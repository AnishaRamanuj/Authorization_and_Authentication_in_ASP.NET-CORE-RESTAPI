...
namespace Authentication_Authorization_core.Controllers
{
    /// add the authorization attribute to the "EmployeeController" controller.
    /// so all the APIs under this controller will be secured with the token.
